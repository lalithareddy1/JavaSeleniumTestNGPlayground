...
public class MyTestNGListener extends BaseClass implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		System.out.println("TestNG Listener");
		...
		File desFile = new File(screenShotFolderPath + date + ".png");
		try {
		...
		//Reporter.log("<a href='" + desFile.getAbsolutePath() + "'> <img src='" + desFile.getAbsolutePath()
